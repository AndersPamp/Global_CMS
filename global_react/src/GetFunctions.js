const GetCountry = async (country) => {
    return await fetch(`http://localhost:16479/${country}/?AltTemplate=AsJson`).then(result => result.json());    
}
...
const GetDepartment = async (country, office, department, employee) => {
